...
function PhotoGallery({ onClose }) {
    ...
    const prev = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PhotoGallery.useCallback[prev]": ()=>setSelected({
                "PhotoGallery.useCallback[prev]": (i)=>Math.max(0, i - 1)
            }["PhotoGallery.useCallback[prev]"])
    }["PhotoGallery.useCallback[prev]"], []);
    const next = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PhotoGallery.useCallback[next]": ()=>setSelected({
                "PhotoGallery.useCallback[next]": (i)=>Math.min(PHOTOS.length - 1, i + 1)
            }["PhotoGallery.useCallback[next]"])
    }["PhotoGallery.useCallback[next]"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PhotoGallery.useEffect": ()=>{
            ...
            if (!el) return;
            const enterGrab = {
                "PhotoGallery.useEffect.enterGrab": ()=>{
            ...
            }["PhotoGallery.useEffect.down"];
            const move = {
                "PhotoGallery.useEffect.move": (e)=>{
            ...
            }["PhotoGallery.useEffect.move"];
            const up = {
                "PhotoGallery.useEffect.up": ()=>{
                    clearTimeout(drag.current.timer);
            ...
            const preventDrag = {
                "PhotoGallery.useEffect.preventDrag": (e)=>e.preventDefault()
            }["PhotoGallery.useEffect.preventDrag"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PhotoGallery.useEffect": ()=>{
            const onKey = {
                "PhotoGallery.useEffect.onKey": (e)=>{
                    if (e.key === 'Escape') onClose();
                    if (e.key === 'ArrowLeft') prev();
                    if (e.key === 'ArrowRight') next();
                }
            }["PhotoGallery.useEffect.onKey"];
            window.addEventListener('keydown', onKey);
            return ({
                "PhotoGallery.useEffect": ()=>window.removeEventListener('keydown', onKey)
            })["PhotoGallery.useEffect"];
        }
    }["PhotoGallery.useEffect"], [
        onClose,
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    onClickCapture: (e)=>{
                        if (drag.current.wasGrabbed) {
                            e.stopPropagation();
                            drag.current.wasGrabbed = false;
                        }
                    },
                    children: PHOTOS.map((photo, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            className: [
                                ...
                                i === selected ? 'ring-2 ring-teal-400 opacity-100 scale-105' : 'opacity-50 hover:opacity-80'
                            ].join(' '),
                            style: {
                                width: 44,
                                height: 59,
...
_s(PhotoGallery, "JYFZ/7NogkgpUNSdSxolJVMMsO0=");
_c = PhotoGallery;
var _c;
...
"[project]/src/components/GalleryButton.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                fileName: "[project]/src/components/GalleryButton.tsx",
                lineNumber: 11,
                columnNumber: 7
            }, this),
...
_s(GalleryButton, "xG1TONbKtDWtdOTrXaTAsNhPg/Q=");
_c = GalleryButton;
var _c;
...
//# sourceMappingURL=src_components_13slm95._.js.map